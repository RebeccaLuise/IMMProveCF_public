...
ps_sputum_filtered <- tax_filter(ps_full_sputum, min_prevalence = 0.1) # has 155 taxa
ps_sputum_filtered_rar <- tax_filter(ps_full_sputum_rar, min_prevalence = 0.1) # has 153 taxa
...
ps_throat_filtered <- tax_filter(ps_full_throat, min_prevalence = 0.3) # has to be prevalent in 30% of samples = 70 taxa
ps_throat_filtered_rar <- tax_filter(ps_full_throat_rar, min_prevalence = 0.3) # has 70 taxa
...
ps_stool_filtered <- tax_filter(ps_full_stool, min_prevalence = 0.3) # has to be prevalent in 30% of samples = 94 taxa
ps_stool_filtered_rar <- tax_filter(ps_full_stool_rar, min_prevalence = 0.3) # has to be prevalent in 30% of samples = 90 taxa
...
"hypertonic_na_cl"="Hypertonic Saline Inhalation", "laba_inhal"= "Long-Acting Beta-Agonist (LABA) Inhaler", "mannitol"="Mannitol Inhalation", "cortison_oral"= "Cortisone", "na_cl_oral"="Sodium suppl.", "ppi"="PPI", "nsaid"="NSAIDs", "insulin"="Insulin", "ssri"="SSRIs", "chlorid_mmol_cl_l"="Sweat chloride (mmol/l)", "interleukin6_pg_ml"="Interleukin-6 (pg/ml)", "calprotectin_amg_g_stuhl"= " Fecal calprotectin (μg/g )", "got_asat_u_l"="GOT/ASAT U/l", "cftr_prior_v1"="prior CFTR-modulator tt", "mutation_status"= "Mutation (homo- vs heterozygous", "azithromycin_oral"="Azithromycin (Oral)", "dpi_colistin" =  "DPI Colistin Inhalation", "bristol"="Bristol Score", "basic_nutrition"="Basic nutrition", "staph_pos_throat"= "Staphylococcus positive throat", "staph_pos_sputum" = "Staphylococcus positive sputum", "pseudo_pos_sputum"= "Pseudomonas positive sputum", "pseudo_pos_throat" = "Pseudomonas positive throat")
...
saveRDS(hm_div_sputum, "/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/hm_div_sputum.rds")
...
diversity_df_sputum_metadata%>% 
  ggplot(aes(x=pp_fev_percent, y=diversity_shannon))+
...
ggsave("/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/sputum_lungFunction_diversity.png", width = 5, height = 4)
```

## MetadeconfoundR for throat diversity
```{r MetadeconfoundR for throat diversity unrarefied, fig.height=4, fig.width=8}
...
```{r MetadeconfoundR for Sputum glomerulated taxa, fig.width=8, fig.height=10}
...
saveRDS(sputum_hm, "/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/sputum_metad.rds")
```
## Staphylococcus
...
saveRDS(p1, "/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/staph_sweat_chloride.rds")
...
ggarrange(pseudomonas, pseu_igg, pseu_leuco, leu, igg, pseu_ab, labels = c("A","B","C","D","E","F"), nrow = 2, ncol = 3, legend = "bottom", common.legend = T)
...
hm_05 <- BuildHeatmap(stool_metad_glom, keepMeta = "delta_ETI_merged", intermedData = T, showConfounded = F, q_cutoff = 0.05, d_cutoff = 0.3)
