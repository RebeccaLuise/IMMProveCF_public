...
sputum_lolli <- sputum_lolli+ theme(text = element_text(size = 12), legend.text = element_text(size = 12), legend.title.position = "top", legend.position = "bottom")
...
grid_arranged <- grid.arrange(
  ...
  sputum_lolli + guides(fill = guide_legend(nrow = 2, ncol = 1))+ labs(tag = "d"), #4
  staph+ labs(tag = "e"), #5
  g + labs(tag = "f"), #6
  ic25 + labs(tag = "g"), #7
