...
lm_stats <-  lm_stats%>%
  ...
  boxplot <- diversity_df_sputum_metadata%>%
    ...
    guides(fill='none') +
    stat_pvalue_manual(lm_stats, label = "fdr_star",y.position = (max(x)-0.07*max(x)), step.increase = 0.05, size=6)
...
lm_stats <-  lm_stats%>%
  ...
  boxplot <- diversity_df_throat_metadata%>%
    ...
    theme(text=element_text(size = 16), legend.position = "none")+
    guides(fill='none') +
    stat_pvalue_manual(lm_stats, label = "fdr_star",y.position = (max(x)-0.07*max(x)), step.increase = 0.06, size=6)
...
lm_stats <-  lm_stats%>%
  ...
  boxplot <- diversity_df_throat_metadata_rar%>%
    ...
    theme(text=element_text(size = 16), legend.position = "none")+
    guides(fill='none') +
    stat_pvalue_manual(lm_stats, label = "fdr_star",y.position = (min(x)-0.07*min(x)), step.increase = 0.05, size = 6)
...
observed_thr_rar_wC <- observed_thr_rar +
  geom_signif(
    ...
    vjust = 1.5,
    size = 0.4,
    textsize = 6 # Adjust this to increase the size of the asterisks
  )
observed_thr_rar_wC
saveRDS(observed_thr_rar_wC, "/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/throat_observed.rds")
...
shannon_thr_rar_wC 
saveRDS(shannon_thr_rar_wC , "/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/throat_shannon.rds")
...
observed_st_rar_wC
saveRDS(observed_st_rar_wC ,"/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/stool_observed.rds")

shannon$lm_stats_sig
shannon_st_rar_wC <- shannon_stool_rar +
  geom_signif(
    y_position = c(1.85, 2 , 2.15, 2.3), 
    xmin = c(2, 3, 4, 5), 
    xmax = c(6, 6, 6, 6),
    annotation = c("***", "***", "***", "***"),
    tip_length = -0.03, 
...
shannon_st_rar_wC 
saveRDS(shannon_st_rar_wC ,"/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/stool_shannon.rds")
...
saveRDS(p1,"/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/sputum_shannon.rds")
saveRDS(p2,"/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/sputum_observed.rds")
...
ggsave("/Users/rebecca/Documents/Forschung/IMMProveCF/Manuscript_16S/Submission_CHM/Fig2.tiff",grid_arranged, dpi = 300, width = 14, height = 14)
```
