---
title: "Calculate Effect size for visits for throat samples across phylogentic levels"
...
ps_throat_relab <- transform_sample_counts(ps_full_throat, function(x) x/sum(x))
ps_throat_relab <-prune_taxa(taxa_sums(ps_throat_relab) > 0.4, ps_throat_relab) # > 40% prevalence over all samples, 107 most abundant ASVs
...
```{r plot cuneiform class, eval=FALSE}
...
effect_table_sig_all_control <- rbind(effect_table_sig_long_control, effect_table_sig_long_control_family, effect_table_sig_long_control_order,effect_table_sig_long_control_class, effect_table_sig_long_control_phylum)
