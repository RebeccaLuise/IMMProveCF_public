...
ps_throat <- tax_filter(ps_throat, min_prevalence = 1,
...
plot_all <- ggplot(center, aes(x = V1, y = V2)) +
  ...
  scale_y_continuous(breaks = c( -0.50, -0.2, 0.00,0.2, 0.5), limits = c(-0.50, 0.50))+
...
saveRDS(plot.plot_throat, "/Users/rebecca/Documents/Forschung/IMMProveCF/R_analysis/figures/starplot_throat.rds")
